...
### Задание #10 - Логирование запросов (Request Logging) ✅
**Статус**: Завершено
**Файлы**:
- Обновлён `com.example.proxy.ProxyResource` - добавлено структурированное логирование всех запросов
**Чему научились**:
- `org.jboss.logging.Logger` — стандартный логгер в Quarkus
- `LOG.infof()`, `LOG.warnf()`, `LOG.errorf()` — форматированные сообщения
- `System.currentTimeMillis()` для измерения времени выполнения (latency)
